...
class agCodeVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by agCodeParser#gMove.
    def visitGMove(self, ctx:agCodeParser.GMoveContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by agCodeParser#gCirc.
    def visitGCirc(self, ctx:agCodeParser.GCircContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by agCodeParser#gWait.
    def visitGWait(self, ctx:agCodeParser.GWaitContext):
        return self.visitChildren(ctx)
